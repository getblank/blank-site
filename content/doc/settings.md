...
Время жизни JWT токена (строка). Задается в формате `HH:MM`, где `HH`&nbsp;&mdash; часы,
а `MM`&nbsp;&mdash; минуты.

**passwordResetTokenExpiration**

Время жизни токена для сброса пароля (строка). Задается в формате `HH:MM`, где `HH`&nbsp;&mdash; часы,
а `MM`&nbsp;&mdash; минуты. По истечении указанного времени, токен обнуляется.

**registerTokenExpiration**

Время, отведённое на активацию зарегистрированных пользователей (строка). Задается в формате `HH:MM`, где `HH`&nbsp;&mdash; часы,
а `MM`&nbsp;&mdash; минуты. В случае неактивации, по истечении указанного времени, пользовательский аккаунт будет удалён из системы.

**ssoOrigins**

Адреса веб-сайтов, которые смогут получить доступ к токену авторизации при использовании механизма Single Sign On
