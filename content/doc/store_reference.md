...
~~~javascript
    "access": [AccessRule]
~~~
Устанавливает права доступа для элементов Store. Доступный набор разрешений: **crud**.
...
~~~
Тип отображения Store в интерфейсе пользователя.
...
Подробнее читайте в разделе [ObjectLifeCycle](/doc/objectLifeCycle/)
